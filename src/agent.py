        ...
        if context_id not in self.conversations:
            ...
            if PROMPT_MODE == "minimal":
                ...
                system_content = (
                    ...
                    "- If user wants to remove one passenger: either cancel the whole reservation (if eligible), "
                    "OR downgrade all passengers to basic_economy (always allowed). Refund to original payment.\n\n"
                    "Booking:\n"
                    ...
                    "## FLIGHT SELECTION\n"
                    "- 'Cheapest economy' = economy cabin ONLY (NOT basic_economy — those are different).\n"
                    "- 'Second cheapest' = sort all matching options by price ascending, pick index 1.\n"
